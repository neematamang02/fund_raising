      ...
      <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-10 px-4 py-14 sm:px-6 md:py-16 lg:grid-cols-2 lg:gap-12 lg:py-20">
        <div className="animate-fadeIn space-y-7 text-center lg:text-left">
          ...
          <div className="space-y-4">
            <h1 className="text-balance-trust text-4xl font-extrabold leading-tight text-slate-900 sm:text-5xl">
              Help Fund Critical Causes With Confidence
            </h1>
            <p className="mx-auto max-w-xl text-base leading-7 text-slate-600 lg:mx-0 lg:text-lg">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
            {metrics.map((metric) => (
              <article
                key={metric.label}
                className="surface-card rounded-xl p-4 text-center transition-colors duration-200 hover:border-blue-200"
              >
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-sm text-slate-600 lg:justify-start">
        ...
        <div className="relative">
          <img
            ...
            className="w-full rounded-2xl border border-slate-200 object-cover shadow-[0_18px_40px_rgba(17,24,39,0.14)]"
          />

          <div className="absolute -left-3 top-4 rounded-xl border border-slate-200 bg-white px-3 py-2 shadow-md sm:-left-6 sm:top-6 sm:px-4 sm:py-3">
            <p className="text-xs font-medium text-slate-500">Raised today</p>
            <p className="text-lg font-bold text-primary">$1,250</p>
          </div>

          <div className="absolute -bottom-3 right-3 rounded-xl border border-slate-200 bg-white px-3 py-2 shadow-md sm:-bottom-6 sm:right-6 sm:px-4 sm:py-3">
            <p className="text-xs font-medium text-slate-500">New donors</p>
